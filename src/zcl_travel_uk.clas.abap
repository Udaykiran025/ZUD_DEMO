CLASS zcl_travel_uk DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_travel_uk IMPLEMENTATION.
...
*   clear data
    DELETE FROM zuk_travel.
*    DELETE FROM zuk_travel.

    "insert travel demo data
    INSERT zuk_travel  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table zuk_travel{ group_id }. | ).
    "out->write( |[RAP100] Demo data generated for table zuk_travel{ group_id }. | ).
